...
export default function ComprobacionPage() {
  ...
  const checks = useMemo(() => {
    ...
    const s = {
      ...
      fisicoAyer:    sumField(data.fisicoAyer,    'total_fisico'),
      fisicoHoy:     sumField(data.fisicoHoy,     'total_fisico'),
                  ...
                  <table className="table-audicen">
                    ...
                    <tbody>
                      {[
                        ...
                        { label: 'Conteo Físico (ayer)',           rows: data.fisicoAyer,    field: 'total_fisico', filtros: `${ayer}` },
                        { label: 'Conteo Físico (hoy)',            rows: data.fisicoHoy,     field: 'total_fisico', filtros: `${fecha}` },
